...
# Script to replace words in files in the ETH-Denver-2025/docs directory
...
show_help() {
    ...
    echo
    echo "Replace words in files within the docs directory."
    echo
    echo "Options:"
...
echo "Starting word replacement process..."
echo "Configuration:"
